let CalculateTotal = () => {
    ...
    console.log("try calculateTotal: " + totalCalculated[i], i+1);
...
let UpdateCouponUsage = (message) => {
    ...
    console.log("try couponUsageUpdate: " + couponUsageUpdated[i], i+1);
...
let ChargeVendorProcessingFee = (message) => {
    ...
    console.log("try vendorProcessingFeeCharge: " + vendorProcessingFeeCharged[i], i+1);
...
let ChargeCreditCard = (message) => {
    ...
    console.log("try creditCardCharge: "+ creditCardCharged[i], i+1);
